...
const {defineComponent,ref: ref$P,shallowRef: shallowRef$M,onMounted: onMounted$f,onBeforeUnmount: onBeforeUnmount$d} = await importShared('vue');
...
const _sfc_main = defineComponent({
  ...
  setup() {
    // 当前显示的组件
    const currentComponent = shallowRef$M(Page);
    // API对象，用于传递给子组件
